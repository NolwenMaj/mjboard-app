...
import CharacterCard from "@/lib/_components/CharacterCard";
import { Card, CardContent } from "@/lib/_components/ui/card";
import { ChevronRightIcon } from "@/lib/_components/ui/customIcons";
import { mockTable } from "@/lib/fixture/mockDatas";
